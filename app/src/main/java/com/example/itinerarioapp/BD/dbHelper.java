package com.example.itinerarioapp.BD;
...
public class dbHelper extends SQLiteOpenHelper {
   ...
   /* public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //SE EJECUTA CUANDO CAMBIA LA VERSIÓN DE LA BD
        //CUANDO AGREGAS UN NUEVO CAMPO O MODIFICAS ALGO
        db.execSQL("DROP TABLE " + TABLE_CONTACTOS);
    }*/

    public void inserta(SQLiteDatabase db){
        db.execSQL("INSERT INTO " + TABLE + "(id,area,fecha,horai,horaf, nombre,actividad, telefono) VALUES (3,'Informatica', '2023-01-01','10:00','10:00','Nay','desa','3421096968')");
    }
